# Agent Spec — agent_b
Generated: 2026-04-28T09:58:13.728745
...
## Your job
Query the n8n API at https://n8n.lorettasercy.com to check the current status of workflows 2.1, 2.2, 3.1, and 3.2 and report whether each is active/green or not.
...
## Output contract
Write your result to: agents/results/agent_b_result.md
