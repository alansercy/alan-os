# Agent Spec — agent_c
Generated: 2026-04-28T09:58:13.729325
...
## Your job
After agent_a and agent_b complete, synthesize both result files into a final status report confirming whether all 3 Google credentials are re-authenticated and all 4 workflows (2.1, 2.2, 3.1, 3.2) are green, flagging any items that need human review.

## Inputs available
- agents/results/agent_a_result.md
- agents/results/agent_b_result.md
- CONTEXT.json

## Output contract
Write your result to: agents/results/agent_c_result.md
